...
//Start of Standard Commands - Edit
void MUL8_MainView::on_walkButton_clicked()
{
    cout << "Walk" << endl;
    setGUIMotorValues();
}

void MUL8_MainView::on_turnLeftButton_clicked()
{
    cout << "Turn Left" << endl;
    setGUIMotorValues();
}

void MUL8_MainView::on_turnRightButton_clicked()
{
    cout << "Turn Right" << endl;
    setGUIMotorValues();
}

void MUL8_MainView::on_standButton_clicked()
{
    cout << "Stand" << endl;
    setGUIMotorValues();
}

void MUL8_MainView::on_stepLeftButton_clicked()
{
    cout << "Step Left" << endl;
    setGUIMotorValues();
}

void MUL8_MainView::on_stepRightButto_clicked()
{
    cout << "Step Right" << endl;
    setGUIMotorValues();
}

void MUL8_MainView::on_kickButton_clicked()
{
    cout << "Kick" << endl;
    setGUIMotorValues();
}

void MUL8_MainView::on_editButton_clicked()
{
    cout << "Edited App" << endl;
    setGUIMotorValues();
}
//End of Standard Commands
